...
public static class CraftingMaterialTemplates
{
    public class IronScrap : CraftingMaterial
    {
        ...
        public IronScrap() : base("Iron Scrap", "A piece of iron scrap.", GoldCoin.FromAmount(10))
        {
        }
    ...
    public class WoodenShoot : CraftingMaterial
    {
        ...
        public WoodenShoot() : base("Wooden Shoot", "A piece of wooden shoot.", GoldCoin.FromAmount(10))
        {
        }
    ...
    public class TatteredCloth : CraftingMaterial
    {
        ...
        public TatteredCloth() : base("Tattered Cloth", "A piece of tattered cloth.", GoldCoin.FromAmount(10))
        {
        }
