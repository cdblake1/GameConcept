...
{
    public static int ApplyScalarModifier(this ScalarOperation operation, int baseDamage)
    {
        switch (operation.ModifierOperation)
        {
            case ScalarOperation.OperationKind.Add:
                baseDamage += operation.Value;
                break;
            case ScalarOperation.OperationKind.Mult:
                baseDamage *= 1 + (operation.Value / 100);
                break;
            case ScalarOperation.OperationKind.Set:
                baseDamage = operation.Value;
                break;
            default:
                break;
